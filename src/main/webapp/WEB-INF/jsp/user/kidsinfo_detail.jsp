...
<body>
		...
		<section class="d-flex justify-content-center align-items-center">
			...
			<div class="submenu-bar d-flex justify-content-center w-100">
				<div class="d-flex justify-content-between align-items-center w-100">
					...
					<div class="d-flex">
					<!-- 목록 버튼 -->
					<div class="ml-3"><a href="/user/accounts/kidsinfo/list_view" class="btn btn-yellow" id="kidsinfoListBtn"><b>목록으로</b></a></div>
					<!-- 저장 버튼 -->
					<div class="ml-2 mr-3"><button type="submit" class="btn btn-yellow" id="kidsinfoUpdateBtn" data-kidsinfo-id="${kidsInfo.id }"><b>수정</b></button></div>
					</div>
				</div>
			</div>
			<!-- page section -->
				...
				<div>
					...
					<div class="info-box mx-3 mt-3">
						...
						<div class="input-group d-flex">
							...
							<input type="text" class="form-control box mt-2" placeholder="자녀 이름" id="kidsNameInput" value="${kidsInfo.kidsName }">
						</div>
						<!-- 자녀생일 -->
						<div class="input-group d-flex">
						...
						<div class="input-group d-flex">
							...
							<select class="form-control box mt-2" id="kidsGenderInput" name="kidsGender" value="${kidsInfo.kidsGender }">
								<option value="${kidsInfo.kidsGender }">--${kidsInfo.kidsGender }--</option>
						...
						<div class="input-group d-flex">
							...
							<select class="form-control box mt-2" id="kidsClassInput" name="kidsClass" value="${kidsInfo.kidsClass }">
								<option value="${kidsInfo.kidsClass }">--${kidsInfo.kidsClass }--</option>
						...
						<div class="input-group d-flex">
							...
							<select class="form-control box mt-2" id="relationshipInput" name="relationship" value="${kidsInfo.relationship }">
								<option value="${kidsInfo.relationship }">--${kidsInfo.relationship }--</option>
	...
	<script>
		$(document).ready(function(){
			...
			//자녀정보 입력
			$("#kidsinfoUpdateBtn").on("click",function(){
				
				
				var kidsinfoId = $(this).data("kidsinfo-id");
